...
int main(int argc, char **argv)
{
	...
	case 1:
		...
		return EXIT_FAILURE;
	case 2:
		theme_id = "tokyonight/tokyonight";
		break;
	case 3:
		theme_id = argv[2];
		break;
	...
	size_t query_length;
	char *query_source = read_file("queries/highlights.scm", &query_length);
	...
	if (!ts_parser_set_language(parser, tree_sitter_cooklang())) {
	...
	TSQuery *query = ts_query_new(tree_sitter_cooklang(), query_source,
